...
| **Later** | Event/webhook triggers, Library and isolated worker Environments. Dashboard, Smart Home and Calendar have landed; see [home-and-calendar.md](home-and-calendar.md). | Each addition has a real user flow and permission model. |
